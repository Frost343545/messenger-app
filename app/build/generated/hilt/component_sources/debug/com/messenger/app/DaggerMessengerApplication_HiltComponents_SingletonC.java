...
import com.messenger.app.di.DatabaseModule_ProvideChatDaoFactory;
import com.messenger.app.di.DatabaseModule_ProvideDatabaseFactory;
import com.messenger.app.di.DatabaseModule_ProvideUserDaoFactory;
import com.messenger.app.di.NetworkModule;
import com.messenger.app.di.NetworkModule_ProvideAuthApiFactory;
import com.messenger.app.di.NetworkModule_ProvideOkHttpClientFactory;
import com.messenger.app.di.NetworkModule_ProvideRetrofitFactory;
import com.messenger.app.ui.viewmodel.AuthViewModel;
import com.messenger.app.ui.viewmodel.AuthViewModel_HiltModules_KeyModule_ProvideFactory;
import com.messenger.app.ui.viewmodel.ChatsViewModel;
import com.messenger.app.ui.viewmodel.ChatsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.messenger.app.ui.viewmodel.ContactsViewModel;
import com.messenger.app.ui.viewmodel.ContactsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.messenger.app.ui.viewmodel.ProfileViewModel;
import com.messenger.app.ui.viewmodel.ProfileViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMessengerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MessengerApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(4).add(AuthViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ChatsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ContactsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ProfileViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MessengerApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.chatsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(4).put("com.messenger.app.ui.viewmodel.AuthViewModel", ((Provider) authViewModelProvider)).put("com.messenger.app.ui.viewmodel.ChatsViewModel", ((Provider) chatsViewModelProvider)).put("com.messenger.app.ui.viewmodel.ContactsViewModel", ((Provider) contactsViewModelProvider)).put("com.messenger.app.ui.viewmodel.ProfileViewModel", ((Provider) profileViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.messenger.app.ui.viewmodel.AuthViewModel 
          return (T) new AuthViewModel(singletonCImpl.authRepositoryProvider.get());

          case 1: // com.messenger.app.ui.viewmodel.ChatsViewModel 
          return (T) new ChatsViewModel(singletonCImpl.chatRepositoryProvider.get(), singletonCImpl.userRepositoryProvider.get());

          case 2: // com.messenger.app.ui.viewmodel.ContactsViewModel 
          return (T) new ContactsViewModel(singletonCImpl.userRepositoryProvider.get());

          case 3: // com.messenger.app.ui.viewmodel.ProfileViewModel 
  ...
  private static final class SingletonCImpl extends MessengerApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.messenger.app.data.remote.repository.AuthRepository 
          return (T) new AuthRepository(singletonCImpl.provideAuthApiProvider.get());

          case 1: // com.messenger.app.data.remote.api.AuthApi 
          ...
          case 4: // com.messenger.app.data.repository.ChatRepository 
          return (T) new ChatRepository(singletonCImpl.chatDao());

          case 5: // com.messenger.app.data.local.AppDatabase 
          return (T) DatabaseModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 6: // com.messenger.app.data.repository.UserRepository 
