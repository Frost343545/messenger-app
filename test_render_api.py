...
# Render API URL
RENDER_API_URL = "https://messenger-app-1-4fo0.onrender.com"

def test_api_health():
    """Тест API здоровья"""
    try:
        print("🔌 Тестирование Render API...")
...
def test_database_status():
    ...
    try:
        ...
        db_url = f"{RENDER_API_URL}/api/database/status"
        print(f"📡 GET {db_url}")
...
if __name__ == "__main__":
    ...
    print("❌ Если ошибки - проверьте логи в Render Dashboard")
    
    print(f"\n🔗 Ваш Render API URL: {RENDER_API_URL}")
    print("📱 Теперь обновите Android приложение!")
